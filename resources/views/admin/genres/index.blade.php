...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-white">Genres</h2>
                <p class="text-sm text-zinc-400 mt-1">Manage all available genres for novels.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-zinc-800">
                        @forelse($genres as $genre)
                            <tr class="group hover:bg-zinc-800/50 transition-colors">
                                <td class="px-6 py-4 text-sm text-zinc-500 font-mono">#{{ $genre->id }}</td>
                                <td class="px-6 py-4 text-sm font-medium text-white">{{ $genre->name }}</td>
                                <td class="px-6 py-4">
                                    <span
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-zinc-500">
                                        ...
                                        <p class="text-base font-medium text-zinc-400">No genres found</p>
                                        <p class="text-sm mt-1">Get started by adding a new genre.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
