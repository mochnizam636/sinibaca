...
@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-white">Add Genre</h2>
                <p class="text-sm text-zinc-400">Create a new genre to categorize novels.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.genres.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="space-y-2">
                    <label for="name" class="block text-sm font-medium text-zinc-300">
                        Genre Name <span class="text-red-400">*</span>
                    </label>
