...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-white">Categories</h2>
                <p class="text-sm text-zinc-400 mt-1">Organize novels into different categories.</p>
            </div>
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b border-zinc-800 bg-zinc-900/50">
                            ...
                            <th class="px-6 py-4 text-xs font-semibold text-zinc-400 uppercase tracking-wider">Description
                            </th>
                    ...
                    <tbody class="divide-y divide-zinc-800">
                        @forelse($categories as $category)
                            <tr class="group hover:bg-zinc-800/50 transition-colors">
                                <td class="px-6 py-4 text-sm text-zinc-500 font-mono">#{{ $category->id }}</td>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-zinc-500">
                                        <i data-lucide="layers" class="w-12 h-12 mb-3 opacity-50"></i>
                                        <p class="text-base font-medium text-zinc-400">No categories found</p>
                                        <p class="text-sm mt-1">Get started by adding a new category.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
