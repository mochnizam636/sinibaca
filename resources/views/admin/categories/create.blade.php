...
@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-white">Add Category</h2>
                <p class="text-sm text-zinc-400">Create a new category for broader classification.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                        placeholder="e.g. Popular, Recommended, Seasonal"
